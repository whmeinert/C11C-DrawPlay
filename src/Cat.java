...
public class Cat {
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		// Draw nose, must be done last because it uses transformation operations
		g2.translate(catX+HEAD_DIMENSION/2-5, catY+HEAD_DIMENSION/2-5);
		g2.rotate(3.141592/4);
		g2.fillOval(0, 0, MOUTH_WIDTH/2, MOUTH_HEIGHT/2);
		
		
		g2.rotate(-3.141592/4);
		g2.fillOval(0, 0, MOUTH_WIDTH/2, MOUTH_HEIGHT/2);
		
		g2.translate(MOUTH_WIDTH/2+1, 4);
		g2.rotate(3.141592/2);
		g2.rotate(3.141592/4);
		g2.fillOval(0, 0, MOUTH_WIDTH/2, MOUTH_HEIGHT/2);
	}
}
